...
declare function computeServerRules(metadataRules: TSubmit64Rule[], fieldType: TFormFieldDef["type"], formProvider: TSubmit64FunctionsProvider): TSubmit64ValidationRule[];
