  ...
  sections: [
    {
      ...
      fields: [
        ...
        {
          field_name: 'test_unlink_association',
          field_type: 'selectBelongsTo',
          label: 'Test Unlink association',
          rules: [],
          static_select_options: [],
          field_association_name: null,
...
function postFakeServerMetadata(
...
function postFakeServerAssociation(
